" 'ubuntu_solarized.vim' -- Vim color scheme.
" Maintainer:  Andrew Keech (w.andrew.keech@gmail.com)
" Ubuntu-friendly theme adapted from Romain Lafourcade's 'Flattened light'
" theme, which in turn was based on Solarized
...
if &t_Co >= 256 || has('gui_running')
  ...
  hi CursorLine                             cterm=NONE             ctermbg=187             guibg=#eee8d5 guisp=#eee8d5      gui=NONE
  ...
  hi Folded                                 term=bold,underline    cterm=NONE,underline    ctermfg=240   ctermbg=187        gui=NONE,underline    guifg=#98a1a1 guibg=#eee8d5 guisp=#fdf6e3 gui=NONE
  ...
  hi Pmenu                                  term=reverse           cterm=reverse           ctermfg=240   ctermbg=187        gui=reverse           guifg=#300c28 guibg=#eee8d5 guibg=NONE    cterm=NONE
  hi PmenuSbar                              term=reverse           cterm=reverse           ctermfg=235   ctermbg=240        gui=reverse           guifg=#300c28 guibg=#98a1a1 guibg=NONE    cterm=NONE
  hi PmenuSel                               term=reverse           cterm=reverse           ctermfg=245   ctermbg=235        gui=reverse           guifg=#300c28 guibg=#073642 guibg=NONE    cterm=NONE
  hi PmenuThumb                             term=reverse           cterm=reverse           ctermfg=240   ctermbg=230        gui=reverse           guifg=#300c28 guibg=#fdf6e3 guibg=NONE    cterm=NONE
  ...
  hi StatusLine                             term=reverse           cterm=reverse           ctermfg=239   ctermbg=187        gui=reverse           guifg=#98a1a1 guibg=#300c28 guibg=NONE    cterm=NONE
  hi StatusLineNC                           term=reverse           cterm=reverse           ctermfg=244   ctermbg=187        gui=reverse           guifg=#839496 guibg=#300c28 guibg=NONE    cterm=NONE
  hi TabLine                                term=underline         cterm=underline         ctermfg=240   ctermbg=187        gui=underline         guifg=#98a1a1 guibg=#eee8d5 guisp=#300c28
  hi TabLineFill                            term=underline         cterm=underline         ctermfg=240   ctermbg=187        gui=underline         guifg=#98a1a1 guibg=#eee8d5 guisp=#300c28
  hi TabLineSel                             term=underline,reverse cterm=underline,reverse ctermfg=245   ctermbg=235        gui=underline,reverse guifg=#98a1a1 guibg=#073642 guisp=#300c28
  ...
  hi VertSplit                              cterm=NONE             ctermfg=244             ctermbg=244   guifg=#300c28      guibg=#300c28         gui=NONE
