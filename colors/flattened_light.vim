...
if &t_Co >= 256 || has('gui_running')
  hi Normal                                                     cterm=NONE  ctermfg=240  ctermbg=230  guifg=#cccccc  guibg=none  gui=NONE

  set background=light

  hi ColorColumn                                                cterm=NONE  ctermbg=187  guibg=#eee8d5  gui=NONE
  hi Comment                                                    cterm=NONE  ctermfg=245  gui=italic  guifg=#9b125b  gui=NONE
  ...
  hi Cursor                                                     cterm=NONE  ctermfg=230  ctermbg=240  guifg=#fdf6e3  guibg=none  gui=NONE
  ...
  hi FoldColumn                                                 cterm=NONE  ctermfg=240  ctermbg=187  guifg=#657b83  guibg=#77216F  gui=NONE
  hi Folded                                                         term=bold,underline  cterm=NONE,underline  ctermfg=240  ctermbg=187  gui=NONE,underline  guifg=#657b83  guibg=#77216F  guisp=#fdf6e3  gui=NONE
  ...
  hi LineNr                                                     cterm=NONE  ctermfg=245  ctermbg=187  guifg=#93a1a1  guibg=none  gui=NONE
