...
if &t_Co >= 256 || has('gui_running')
  hi  Normal                                  cterm=NONE  ctermfg=244  ctermbg=234  guifg=#ffffff  guibg=none  gui=NONE
  ...
  hi  Constant                                cterm=NONE  ctermfg=37  guifg=#ffffff  gui=NONE
  hi  Cursor                                  cterm=NONE  ctermfg=234  ctermbg=244  guifg=#002b36  guibg=#bbbbbb  gui=NONE
  ...
  hi  FoldColumn                              cterm=NONE ctermfg=244  ctermbg=235  guifg=#bbbbbb  guibg=#073642  gui=NONE
  hi  Folded                                  term=bold,underline  cterm=NONE,underline  ctermfg=244  ctermbg=235 guifg=#bbbbbb  guibg=#073642  guisp=#002b36  gui=NONE,underline
  ...
  hi  LineNr                                  cterm=NONE ctermfg=239  ctermbg=235  guifg=#586e75  guibg=none  gui=NONE
  ...
  hi  Pmenu                                   term=reverse  cterm=reverse  ctermfg=244  ctermbg=235  guifg=#bbbbbb  guibg=#073642  gui=reverse
  hi  PmenuSbar                               term=reverse  cterm=reverse  ctermfg=187  ctermbg=244  guifg=#eee8d5  guibg=#bbbbbb  gui=reverse
  hi  PmenuSel                                term=reverse  cterm=reverse  ctermfg=239  ctermbg=187  guifg=#586e75  guibg=#eee8d5  gui=reverse
  hi  PmenuThumb                              term=reverse  cterm=reverse  ctermfg=244  ctermbg=234  guifg=#bbbbbb  guibg=#002b36  gui=reverse
  ...
  hi  SignColumn                              cterm=NONE  ctermfg=244  ctermbg=242  guifg=#bbbbbb  guibg=Grey  gui=NONE
  ...
  hi  TabLine                                 term=underline  cterm=underline  ctermfg=244  ctermbg=235  guifg=#bbbbbb  guibg=#073642  guisp=#bbbbbb  gui=underline
  hi  TabLineFill                             term=underline  cterm=underline  ctermfg=244  ctermbg=235  guifg=#bbbbbb  guibg=#073642  guisp=#bbbbbb  gui=underline
  hi  TabLineSel                              term=underline,reverse  cterm=underline,reverse  ctermfg=239  ctermbg=187  guifg=#586e75  guibg=#eee8d5  guisp=#bbbbbb  gui=underline,reverse
  ...
  hi  Type                                    cterm=NONE  ctermfg=136  guifg=#ffffff  gui=NONE
  ...
  hi  gitcommitFile                           term=bold  cterm=NONE  ctermfg=244  guifg=#bbbbbb  gui=NONE
  ...
  hi  hsStatement                             cterm=NONE  ctermfg=37  guifg=#ffffff  gui=NONE
  ...
  hi  pandocBlockQuoteLeader5                 cterm=NONE  ctermfg=244  guifg=#bbbbbb  gui=NONE
  ...
  hi  pandocEmphasis                          cterm=NONE  ctermfg=244  guifg=#bbbbbb  gui=italic
  ...
  hi  pandocEmphasisNested                    term=bold  cterm=NONE  ctermfg=244  guifg=#bbbbbb  gui=NONE
  ...
  hi  pandocStrongEmphasis                    term=bold  cterm=NONE  ctermfg=244  guifg=#bbbbbb  gui=NONE
  hi  pandocStrongEmphasisDefinition          term=bold  cterm=NONE  ctermfg=61  guifg=#6c71c4  gui=NONE
  hi  pandocStrongEmphasisEmphasis            term=bold  cterm=NONE  ctermfg=244  guifg=#bbbbbb  gui=NONE
  ...
  hi  pandocStrongEmphasisNested              term=bold  cterm=NONE  ctermfg=244  guifg=#bbbbbb  gui=NONE
